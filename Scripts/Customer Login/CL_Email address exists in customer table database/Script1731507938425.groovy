...
if(messagePresent) {
	...
	WebUI.verifyMatch(message, 'Sorry! Your account is inactive. Please contact to the administrator.', false)
	
}else {
	KeywordUtil.markFailed("Failed. Error message does not appear.")
}
