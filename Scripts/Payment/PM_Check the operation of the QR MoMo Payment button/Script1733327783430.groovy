...
WebUI.click(findTestObject('Payment/btn_Payment Section_MoMo'))
...
currentUrl.contains('test-payment.momo.vn')
//WebUI.verifyMatch(currentUrl, '.*test-payment.momo.vn*', true) // Kiểm tra trang QR MOMO
